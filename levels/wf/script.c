...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 930, 100, 19, 0, -90, 0, (8 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 4635, 49, 4468, 0, 180, 0, (9 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 2073, 49, 1484, 0, 149, 0, (10 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 3771, 49, 753, 0, -99, 0, (11 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 3861, 49, 325, 0, -99, 0, (12 << 16), bhvMessagePanel),
		OBJECT(MODEL_STAR, 4690, 535, 9860, 0, 180, 0, (0 << 16), bhvStar),
		OBJECT(MODEL_WOODEN_SIGNPOST, 6550, 49, 1363, 0, 177, 0, (15 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 7783, 149, 1993, 0, 177, 0, (11 << 16), bhvFadingWarp),
		OBJECT(MODEL_WOODEN_SIGNPOST, 4914, 1545, 14248, 0, 177, 0, (12 << 16), bhvFadingWarp),
		OBJECT(MODEL_TV, 4734, 410, -2559, 0, 0, 0, 0x00000000, bhvTV),
