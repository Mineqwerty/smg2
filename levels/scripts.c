...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_1UP,                     trollface_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_KOOPA_SHELL,             car_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TROLLFACE,             trollface_geo),
    LOAD_MODEL_FROM_GEO(MODEL_FAST_FLOWER,             fastflower_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TV,             joop_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SCREWDRIVER,             screwdriver_geo),
